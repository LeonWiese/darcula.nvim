...
function M.apply()
    ...
    vim.api.nvim_set_hl(0, "Constant", { fg = c.purple, bg = nil })
    ...
    vim.api.nvim_set_hl(0, "@lsp.type.selfKeyword.rust", { fg = c.orange, bg = nil })
    vim.api.nvim_set_hl(0, "@lsp.type.selfTypeKeyword.rust", { fg = c.orange, bg = nil })
    vim.api.nvim_set_hl(0, "@lsp.type.enumMember.rust", { fg = c.purple, bg = nil, italic = true })
    vim.api.nvim_set_hl(0, "@lsp.typemod.constParameter.constant.rust", { fg = c.purple, bg = nil })
